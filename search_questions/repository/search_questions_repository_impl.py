...
from search_questions.repository.search_questions_repository import SearchQuestionsRepository
from template.include.socket_server.utility.color_print import ColorPrinter


class SearchQuestionsRepositoryImpl(SearchQuestionsRepository):
